  ...
  return (
    <SectionWrapper>
      <form onSubmit={applyFilters} className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 w-full">
        <div className="flex items-center gap-2 w-full lg:w-auto max-lg:hidden max-md:flex mb-auto">
        ...
        <button
          type="submit"
          className={cn("bg-primary hover:bg-secondary text-white rounded-lg px-6 py-2.5 font-semibold",
            " transition-all duration-300 cursor-pointer shadow-sm hover:shadow-md w-full md:w-auto whitespace-nowrap",
            "md:mt-auto ml-auto")}
        >
          Apply Filters
        </button>
